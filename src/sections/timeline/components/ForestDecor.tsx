...
export const ForestDecor = () => {
  return (
    ...
    >
      ...
      >
        {/* Subtle Fireflies */}
        <circle cx="120" cy="180" r="3" fill="#E7C34D" opacity="0.6" />
        <circle cx="880" cy="250" r="2.5" fill="#6EE7B7" opacity="0.7" />
        <circle cx="200" cy="550" r="3" fill="#60A5FA" opacity="0.6" />
        <circle cx="800" cy="720" r="2.5" fill="#E7C34D" opacity="0.7" />
        ...
        <path d="M 700 480 L 703 486 L 709 489 L 703 492 L 700 498 L 697 492 L 691 489 L 697 486 Z" fill="#9AC3F9" opacity="0.5" />
        ...
        <path d="M 920 600 Q 940 590 950 610 Q 935 620 920 600 Z" fill="#3882F1" opacity="0.12" />
      </Box>
    </Box>
  );
};
