...
const FOOTSTEP_LOCATIONS = [
  // Segment 1 -> 2
  { x: 50, y: 165, rotation: 45, color: '#3882F1', delay: 0.4 },
  // Segment 2 -> 3
  { x: 50, y: 355, rotation: -135, color: '#D65890', delay: 1.0 },
  // Segment 3 -> 4
  { x: 50, y: 545, rotation: 45, color: '#9E7A19', delay: 1.6 },
  // Segment 4 -> 5
      ...
      >
        <defs>
          ...
          <linearGradient id="threadGradient" x1="0%" y1="0%" x2="0%" y2="100%">
            ...
            <stop offset="25%" stopColor="#D65890" />
            <stop offset="50%" stopColor="#9E7A19" />
