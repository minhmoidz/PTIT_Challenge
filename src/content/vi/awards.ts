  ...
  qualifierBenefits: [
    {
      ...
      accentColor: '#E11414',
      bgTint: 'rgba(225, 20, 20, 0.1)',
      borderTint: 'rgba(225, 20, 20, 0.25)',
    },
    {
      id: 'education',
      step: '02',
      ...
      iconName: 'School',
      accentColor: '#35547E',
      bgTint: 'rgba(53, 84, 126, 0.1)',
      borderTint: 'rgba(53, 84, 126, 0.25)',
    },
    {
      id: 'mentoring',
      step: '03',
      ...
      accentColor: '#9E7A19',
      bgTint: 'rgba(231, 195, 77, 0.12)',
      borderTint: 'rgba(231, 195, 77, 0.25)',
    },
    {
      id: 'pilot',
      step: '04',
    ...
    },
    {
      ...
      iconName: 'Psychology',
      accentColor: '#D94343',
      bgTint: 'rgba(217, 67, 67, 0.1)',
      borderTint: 'rgba(217, 67, 67, 0.25)',
    },
  ] as QualifierBenefit[],
};
